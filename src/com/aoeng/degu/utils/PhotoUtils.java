...
public class PhotoUtils {
	static String[] filePathColumn = { MediaStore.Images.Media.DATA, MediaStore.Images.Media.LATITUDE, MediaStore.Images.Media.LONGITUDE, MediaStore.Images.Media.SIZE, MediaStore.Images.Media.TITLE,
	...
	private static Collection<? extends ImageInfo> getAutoGroup(String url, Uri uri) {
		...
		selection.append(MediaStore.Images.Media.DATA + " LIKE '%" + url + "%' and (");
		selection.append(Media.MIME_TYPE).append("=?");
		selection.append(" or ");
		selection.append(Media.MIME_TYPE).append("=?) and ");
		selection.append(MediaStore.Images.Media.SIZE).append(">?");
