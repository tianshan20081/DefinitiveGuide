...
import com.aoeng.degu.domain.BenchmarkItem;
...
public final class BenchmarkAsyncTask extends AsyncTask<Object, Object, String> {
	...
	private final BenchmarkUI benchmarkActivity;
	private final String path;

	BenchmarkAsyncTask(BenchmarkUI benchmarkActivity, String path) {
  ...
  protected String doInBackground(Object... params) {
	...
	private static BenchmarkItem decode(MultiFormatReader reader, String path) {
		...
		for (int x = 0; x < RUNS; x++) {
			boolean success;
			Result result = null;
			// Using this call instead of getting the time should eliminate a
			// lot of variability due to
